...
- Selected type: "${triggerData?.type || "unknown"}"
...
`;
    ...
    try {
        ...
        try {
            ...
            // fallback response (VERY IMPORTANT for demo)
            aiResponse = {
                crisisType: triggerData?.type || "unknown",
                confidence: 0.5,
                severity: "medium",
                isAmbiguous: true,
        ...
        let baseConfidence = parseFloat(aiResponse.confidence) || 0.5;
        ...
        const updates = {
            ...
            is_ambiguous: aiResponse.isAmbiguous ?? true,
            recommendation: aiResponse.recommendation ?? "monitor",
